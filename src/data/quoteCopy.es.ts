...
export const ES_COPY: QuoteCopy = {
  ...
  quote: {
    ...
    promoLabel: '¿Nos conocemos?',
    promoPlaceholder: 'Probá un código…',
    promoApplied: (label, percent) => `${label} — ${percent}% de descuento, por ser vos`,
    promoInvalid: 'Ese no es de los míos. Fijate cómo se escribe.',
    promoHelp: 'Los amigos, los clientes de siempre y cualquiera con quien me haya tomado una birra suelen saber las palabras. Si sos de esos, van acá.',
    promoScope: 'Sale de mi tiempo. El alquiler de equipos y los viajes se facturan al costo igual — incluso para vos.',
